    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center py-16 lg:py-24">
      ...
      <div class="relative hidden lg:flex items-center justify-center min-h-[540px]">
        ...
        <div class="ad-card bg-white w-52 absolute bottom-8 left-0 float-3 z-10">
          <div class="relative h-28 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=150&fit=crop&crop=center" alt="Lawn Care" class="w-full h-full object-cover"/>
            <div class="absolute top-2 left-2">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="ad-card bg-white cursor-pointer">
              <div class="relative h-24">
                <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=200&h=120&fit=crop&crop=center" alt="Roofing" class="w-full h-full object-cover"/>
            ...
            <div class="ad-card bg-white cursor-pointer">
              <div class="relative h-24">
                <img src="https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=200&h=120&fit=crop&crop=center" alt="Party Rentals" class="w-full h-full object-cover"/>
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
...
<section class="section-dark py-20 lg:py-28">
  <div class="max-w-7xl mx-auto px-4">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 reveal">
      ...
      <div class="glass rounded-2xl overflow-hidden feature-card">
        <div class="relative">
          <img src="https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=500&h=220&fit=crop&crop=center" alt="Party Rentals" class="w-full h-44 object-cover"/>
          <div class="absolute top-3 left-3 flex gap-2">
      ...
      <div class="glass rounded-2xl overflow-hidden feature-card">
        <div class="relative">
          <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=500&h=220&fit=crop&crop=center" alt="Roofing" class="w-full h-44 object-cover"/>
          <div class="absolute top-3 left-3 flex gap-2">
      ...
      <div class="glass rounded-2xl overflow-hidden feature-card">
        <div class="relative">
          <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=220&fit=crop&crop=center" alt="Lawn Care" class="w-full h-44 object-cover"/>
          <div class="absolute top-3 left-3 flex gap-2">
            <span class="bg-blue-600 text-white text-xs font-bold px-2 py-0.5 rounded">Facebook Ad</span>
          </div>
          <div class="absolute top-3 right-3">
